...
public class VideoCallController {
	...
	public ResponseEntity<Object> startVideoCall(@RequestHeader("Authorization") String accessToken, VideoCallParams params) {
		Object callData = videoCallService.startCall(params);
