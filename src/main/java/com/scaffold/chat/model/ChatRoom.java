...
public class ChatRoom {
	...
	private List<String> chatRoomMemebersId;
	...
	public ChatRoom(String chatRoomName, String chatRoomCreatorId, List<String> chatRoomMemebersId) {
	...
	public void setChatRoomCreatorId(String chatRoomCreatorId) {
		this.chatRoomCreatorId = chatRoomCreatorId;
	}

	public List<String> getChatRoomMemebersId() {
		return chatRoomMemebersId;
	}

	public void setChatRoomMemebersId(List<String> chatRoomMemebersId) {
		this.chatRoomMemebersId = chatRoomMemebersId;
	}
